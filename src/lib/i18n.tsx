...
const STRINGS: Record<string, string> = {
  ...
  "help.toggleFullscreen": "Plein ecran",
  ...
  "help.closeAny": "Fermer toute fenetre",
  "help.feature.markdown.title": "markdown",
  "help.feature.markdown.body": "ecriture + apercu en direct",
  "help.feature.context.title": "LaTeX",
  "help.feature.context.body": "MathJax -- Phase 2",
  "help.feature.csv.title": "csv",
  "help.feature.csv.body": "apercu tableau",
  "help.feature.themes.title": "themes",
  "help.feature.themes.body": "10 palettes",
  "help.tip1": "Glissez un fichier dans la fenetre pour l'ouvrir",
  "help.tip2": "**⌘K** ouvre la palette depuis n'importe ou",
  "help.tip3": "Cliquez droit sur un fichier pour plus d'options",
  "help.tip4": "**⌘.** bascule en mode lecture plein ecran",
  "help.tip5": "Glissez le separateur pour ajuster l'espace editeur/apercu",
  "help.tip6": "**⌘N** cree un fichier temporaire non sauvegarde",
  "help.tip7": "Pincer un fichier le garde en haut de la barre laterale",
  "help.tip8": "**⌘/** rouvre cette aide a tout moment",
  "command.checkUpdates": "Verifier les mises a jour",
};
